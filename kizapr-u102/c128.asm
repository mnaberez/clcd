...
;TODO probably data
        ...
        jmp     (C128_1F0C,x)                       ; D4E6 7C 0C 1F                 |..
        rmb6    $CA                             ; D4E9 67 CA                    g.
        jmp     (C128_53DE,x)                       ; D4EB 7C DE 53                 |.S
        .byte   $CB                             ; D4EE CB                       .
        cmp     ($7D,x)                         ; D4EF C1 7D                    .}
        trb     $64                             ; D4F1 14 64                    .d
...
;TODO probably data
        ...
        pha                                     ; D526 48                       H
        ldy     #$02                            ; D527 A0 02                    ..
LD529:  jsr     C128_42E4                           ; D529 20 E4 42                  .B
        dey                                     ; D52C 88                       .
        sta     $3F,y                           ; D52D 99 3F 00                 .?.
        bne     LD529                           ; D530 D0 F7                    ..
        jsr     C128_42E4                           ; D532 20 E4 42                  .B
        sta     stack+53                        ; D535 8D 35 01                 .5.
        tay                                     ; D538 A8                       .
        beq     LD546                           ; D539 F0 0B                    ..
LD53B:  dey                                     ; D53B 88                       .
        jsr     C128_42D0                           ; D53C 20 D0 42                  .B
        cmp     #$23                            ; D53F C9 23                    .#
LD541:  beq     LD549                           ; D541 F0 06                    ..
        tya                                     ; D543 98                       .
        bne     LD53B                           ; D544 D0 F5                    ..
LD546:  jmp     C128_795A                           ; D546 4C 5A 79                 LZy
; ----------------------------------------------------------------------------
LD549:  lda     #$3B                            ; D549 A9 3B                    .;
LD54B:  jsr     C128_794C                           ; D54B 20 4C 79                  Ly
        sty     $77                             ; D54E 84 77                    .w
        sty     stack+35                        ; D550 8C 23 01                 .#.
        jsr     C128_77DD                           ; D553 20 DD 77                  .w
        bit     $0F                             ; D556 24 0F                    $.
...
LD5B1:  jsr     L86DF                           ; D5B1 20 DF 86                  ..
        jsr     C128_9792                           ; D5B4 20 92 97                  ..
        jsr     C128_95DA                           ; D5B7 20 DA 95                  ..
...
LD62A:  jsr     L98E5                           ; D62A 20 E5 98                  ..
        ...
        jsr     C128_9767                           ; D641 20 67 97                  g.
        dec     stack+2,x                       ; D644 DE 02 01                 ...
        inx                                     ; D647 E8                       .
        stx     stack+41                        ; D648 8E 29 01                 .).
        jsr     C128_97EE                           ; D64B 20 EE 97                  ..
...
LD6D4:  lda     stack+42                        ; D6D4 AD 2A 01                 .*.
        ...
        inc     $77                             ; D6DC E6 77                    .w
        jmp     C128_9675                           ; D6DE 4C 75 96                 Lu.
; ----------------------------------------------------------------------------
        sec                                     ; D6E1 38                       8
...
LD78B:  jsr     C128_42D0                           ; D78B 20 D0 42                  .B
...
LD7FB:  inc     $80                             ; D7FB E6 80                    ..
        ...
        iny                                     ; D808 C8                       .
LD809:  jsr     C128_97F5                           ; D809 20 F5 97                  ..
...
LD91A:  jsr     C128_977E                           ; D91A 20 7E 97                  ~.
...
LD931:  jmp     C128_795A                           ; D931 4C 5A 79                 LZy
; ----------------------------------------------------------------------------
LD934:  jsr     C128_99A6                           ; D934 20 A6 99                  ..
...
LD957:  cmp     #$5E                            ; D957 C9 5E                    .^
        ...
        ldx     #$02                            ; D95B A2 02                    ..
LD95D:  jsr     C128_977E                           ; D95D 20 7E 97                  ~.
...
; ----------------------------------------------------------------------------
        ...
        jsr     C128_77DD                           ; D9BE 20 DD 77                  .w
        jsr     C128_77CB                           ; D9C1 20 CB 77                  .w
        lda     $66                             ; D9C4 A5 66                    .f
        ...
        jsr     C128_8805                           ; D9D9 20 05 88                  ..
LD9DC:  jsr     C128_7944                           ; D9DC 20 44 79                  Dy
        ldx     $67                             ; D9DF A6 67                    .g
        bne     LD9E6                           ; D9E1 D0 03                    ..
        jmp     C128_7D16                           ; D9E3 4C 16 7D                 L.}
; ----------------------------------------------------------------------------
LD9E6:  dex                                     ; D9E6 CA                       .
        stx     $63                             ; D9E7 86 63                    .c
        ldx     #$03                            ; D9E9 A2 03                    ..
...
; Evaluate <rdot>
        jsr     C128_87F3                           ; DAFF 20 F3 87                  ..
        cpx     #$02                            ; DB02 E0 02                    ..
        bcc     LDB16                           ; DB04 90 10                    ..
        beq     LDB0B                           ; DB06 F0 03                    ..
        jmp     C128_7D16     ; Print 'illegal quantity'                    ; DB08 4C 16 7D                 L.}
; ----------------------------------------------------------------------------
LDB0B:  jsr     C128_9C3C     ; Examine Pixel                      ; DB0B 20 3C 9C                  <.
        tay                                     ; DB0E A8                       .
        bcc     LDB13                           ; DB0F 90 02                    ..
        ldy     #$00                            ; DB11 A0 00                    ..
LDB13:  jmp     C128_84D0     ; Byte To Float                      ; DB13 4C D0 84                 L..
; ----------------------------------------------------------------------------
LDB16:  txa                                     ; DB16 8A                       .
        asl     a                               ; DB17 0A                       .
        tax                                     ; DB18 AA                       .
...
LDB20:  jmp     C128_792A     ; Fixed-Float                      ; DB20 4C 2A 79                 L*y
; ----------------------------------------------------------------------------
...
LDBFE:  jsr     C128_9C0C                           ; DBFE 20 0C 9C                  ..
...
; Set Hi-Res Color Cell
        lda     C128_C033,x      ; Screen Address Low                   ; DC63 BD 33 C0                 .3.
        sta     $8C                             ; DC66 85 8C                    ..
        lda     C128_9CBD,x      ; Video Matrix Lines Hi                   ; DC68 BD BD 9C                 ...
        sta     $8D                             ; DC6B 85 8D                    ..
        lda     $83                             ; DC6D A5 83                    ..
...
;TODO incorrect disassembly, should be jsr
        ...
        tya                                     ; DCDB 98                       .
        clc                                     ; DCDC 18                       .
        adc     C128_C033,x   ; Screen Address Low                      ; DCDD 7D 33 C0                 }3.
        sta     $8C                             ; DCE0 85 8C                    ..
...
; Check Optional Float/Fixed Parameter
        ...
        jsr     C128_794A    ; -Check Comma                       ; DDFE 20 4A 79                  Jy
        cmp     #$2C                            ; DE01 C9 2C                    .,
        beq     LDE0A                           ; DE03 F0 05                    ..
        jsr     C128_880E    ; -Input Float/Fixed Value                       ; DE05 20 0E 88                  ..
        sec                                     ; DE08 38                       8
        rts                                     ; DE09 60                       `
...
; Input Optional Byte Parameter   -Check Byte Parameter in List
        ...
        jsr     C128_794A                           ; DE16 20 4A 79                  Jy
        cmp     #$2C    ; -Check Comma                        ; DE19 C9 2C                    .,
        beq     LDE0D                           ; DE1B F0 F0                    ..
        jsr     C128_87F0   ; -Eval Byte Parameter                        ; DE1D 20 F0 87                  ..
        sec                                     ; DE20 38                       8
        rts                                     ; DE21 60                       `
; ----------------------------------------------------------------------------
...
; Get Color Source Param
        ...
        jsr     C128_87F0    ; -Eval Byte Parameter                       ; DE30 20 F0 87                  ..
        cpx     #$04                            ; DE33 E0 04                    ..
...
LDE3F:  stx     $83                             ; DE3F 86 83                    ..
        rts                                     ; DE41 60                       `
; ----------------------------------------------------------------------------
LDE42:  jmp     C128_7D16     ; Print 'illegal quantity'                      ; DE42 4C 16 7D                 L.}
; ----------------------------------------------------------------------------
        jsr     DFLTO     ; CHRGOT entry                      ; DE45 20 86 03                  ..
        beq     LDE51                           ; DE48 F0 07                    ..
        jsr     C128_794A     ; -Check Comma                      ; DE4A 20 4A 79                  Jy
        cmp     #$2C                            ; DE4D C9 2C                    .,
...
LDEA0:  jsr     C128_9AC1                           ; DEA0 20 C1 9A                  ..
...
LDF5D:  jmp     C128_4D37                           ; DF5D 4C 37 4D                 L7M
; ----------------------------------------------------------------------------
...
LDFA5:  clc                                     ; DFA5 18                       .
        ...
        adc     #$24                            ; DFB6 69 24                    i$
        sta     $44                             ; DFB8 85 44                    .D
        jsr     C128_4F4C                           ; DFBA 20 4C 4F                  LO
        jsr     C128_4F7F                           ; DFBD 20 7F 4F                  .O
        bit     $7F                             ; DFC0 24 7F                    $.
...
LDFCC:  txa                                     ; DFCC 8A                       .
        ...
        jsr     C128_5044                           ; DFE2 20 44 50                  DP
...
LE06C:  ldx     #$23                            ; E06C A2 23                    .#
        jmp     C128_4D39   ; Error                        ; E06E 4C 39 4D                 L9M
; ----------------------------------------------------------------------------

; Perform [catalog/directory]
        jsr     C128_A396                           ; E071 20 96 A3                  ..
        lda     $80                             ; E074 A5 80                    ..
        and     #$E6                            ; E076 29 E6                    ).
        beq     LE07D                           ; E078 F0 03                    ..
        jmp     C128_795A        ; Syntax Error                   ; E07A 4C 5A 79                 LZy
; ----------------------------------------------------------------------------
...
LE08D:  txa                                     ; E08D 8A                       .
        ...
        lda     #$00                            ; E09C A9 00                    ..
        jsr     C128_924A                           ; E09E 20 4A 92                  J.
        sec                                     ; E0A1 38                       8
        jsr     C128_90CB                           ; E0A2 20 CB 90                  ..
        bcc     LE0B0                           ; E0A5 90 09                    ..
        pha                                     ; E0A7 48                       H
        jsr     C128_A107                           ; E0A8 20 07 A1                  ..
        pla                                     ; E0AB 68                       h
        tax                                     ; E0AC AA                       .
...
LE0BD:  jsr     C128_9256                           ; E0BD 20 56 92                  V.
        sta     $1175                           ; E0C0 8D 75 11                 .u.
        jsr     C128_9244                           ; E0C3 20 44 92                  D.
        bne     LE107                           ; E0C6 D0 3F                    .?
        jsr     C128_9256                           ; E0C8 20 56 92                  V.
        sta     $1176                           ; E0CB 8D 76 11                 .v.
        jsr     C128_9244                           ; E0CE 20 44 92                  D.
        bne     LE107                           ; E0D1 D0 34                    .4
        dec     $1174                           ; E0D3 CE 74 11                 .t.
        bne     LE0BD                           ; E0D6 D0 E5                    ..
        ldx     $1175                           ; E0D8 AE 75 11                 .u.
        lda     $1176                           ; E0DB AD 76 11                 .v.
        jsr     C128_8E25                           ; E0DE 20 25 8E                  %.
        lda     #$20                            ; E0E1 A9 20                    .
        jsr     C128_925C                           ; E0E3 20 5C 92                  \.
        jsr     C128_9256                           ; E0E6 20 56 92                  V.
        pha                                     ; E0E9 48                       H
        jsr     C128_9244                           ; E0EA 20 44 92                  D.
        bne     LE106                           ; E0ED D0 17                    ..
        pla                                     ; E0EF 68                       h
        beq     LE0F8                           ; E0F0 F0 06                    ..
        jsr     C128_925C                           ; E0F2 20 5C 92                  \.
        jmp     C128_A0E6                           ; E0F5 4C E6 A0                 L..
; ----------------------------------------------------------------------------
LE0F8:  lda     #$0D                            ; E0F8 A9 0D                    ..
        jsr     C128_925C                           ; E0FA 20 5C 92                  \.
        jsr     C128_9286                           ; E0FD 20 86 92                  ..
...
LE15D:  ldx     #$01                            ; E15D A2 01                    ..
        jmp     C128_4D39                           ; E15F 4C 39 4D                 L9M
; ----------------------------------------------------------------------------
...
; Perform [bsave]
        ...
        jmp     C128_795A                           ; E1CD 4C 5A 79                 LZy
; ----------------------------------------------------------------------------
...
LE210:  sta     stack+29                        ; E210 8D 1D 01                 ...
        ...
        php                                     ; E22D 08                       .
        jsr     C128_9236                           ; E22E 20 36 92                  6.
        plp                                     ; E231 28                       (
        bcc     LE237                           ; E232 90 03                    ..
        jmp     C128_90C3                           ; E234 4C C3 90                 L..
; ----------------------------------------------------------------------------
LE237:  jsr     C128_9244                           ; E237 20 44 92                  D.
        and     #$BF                            ; E23A 29 BF                    ).
        beq     LE241                           ; E23C F0 03                    ..
        jmp     C128_915A                           ; E23E 4C 5A 91                 LZ.
; ----------------------------------------------------------------------------
LE241:  clc                                     ; E241 18                       .
        rts                                     ; E242 60                       `
; ----------------------------------------------------------------------------
...
LE262:  jsr     C128_A373                           ; E262 20 73 A3                  s.
        ...
        ldx     #$24                            ; E277 A2 24                    .$
        jmp     C128_4D39                           ; E279 4C 39 4D                 L9M
; ----------------------------------------------------------------------------
LE27C:  rts                                     ; E27C 60                       `
; ----------------------------------------------------------------------------
...
LE2AA:  lda     #$0D                            ; E2AA A9 0D                    ..
        jsr     C128_90D2                           ; E2AC 20 D2 90                  ..
LE2AF:  rts                                     ; E2AF 60                       `
; ----------------------------------------------------------------------------
LE2B0:  jmp     C128_795A                           ; E2B0 4C 5A 79                 LZy
; ----------------------------------------------------------------------------

; Perform [record]

        lda     #$23                            ; E2B3 A9 23                    .#
        jsr     C128_794C                           ; E2B5 20 4C 79                  Ly
        jsr     C128_87F0                           ; E2B8 20 F0 87                  ..
        cpx     #$00                            ; E2BB E0 00                    ..
...
LE2F6:  jmp     C128_7D16                           ; E2F6 4C 16 7D                 L.}
; ----------------------------------------------------------------------------
LE2F9:  ldx     #$04                            ; E2F9 A2 04                    ..
        jmp     C128_4D39                           ; E2FB 4C 39 4D                 L9M
; ----------------------------------------------------------------------------

; Perform [dclear]
        jsr     C128_A396                           ; E2FE 20 96 A3                  ..
        ldy     #$FF                            ; E301 A0 FF                    ..
        lda     #$02                            ; E303 A9 02                    ..
        jsr     C128_A373                           ; E305 20 73 A3                  s.
        jmp     C128_A176                           ; E308 4C 76 A1                 Lv.
; ----------------------------------------------------------------------------
; Perform [collect]
...
LE3AD:  lda     C128_A38F,x      ; Default DOS Disk Unit (U8 D0)                   ; E3AD BD 8F A3                 ...
...
;get bank number
LE419:  jsr     C128_A575                           ; E419 20 75 A5                  u.
...
LE431:  jmp     C128_795A                           ; E431 4C 5A 79                 LZy
; ----------------------------------------------------------------------------
...
LE46C:  jmp     C128_7D16                           ; E46C 4C 16 7D                 L.}
; ----------------------------------------------------------------------------
;get format ID
...
LE575:  lda     #$01                            ; E575 A9 01                    ..
        ...
        rts                                     ; E58C 60                       `
; ----------------------------------------------------------------------------
LE58D:  jmp     C128_795A                           ; E58D 4C 5A 79                 LZy
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        jsr     C128_87F0                           ; E5D1 20 F0 87                  ..
        jmp     C128_7944                           ; E5D4 4C 44 79                 LDy
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        jsr     C128_880E                           ; E5E4 20 0E 88                  ..
        jsr     C128_7944                           ; E5E7 20 44 79                  Dy
        ldy     $16                             ; E5EA A4 16                    ..
        lda     $17                             ; E5EC A5 17                    ..
        rts                                     ; E5EE 60                       `
; ----------------------------------------------------------------------------
LE5EF:  jmp     C128_880E                           ; E5EF 4C 0E 88                 L..
; ----------------------------------------------------------------------------
        and     $80                             ; E5F2 25 80                    %.
...
LE722:  jmp     C128_795A                           ; E722 4C 5A 79                 LZy
; ----------------------------------------------------------------------------
...
LE824:  lda     $11D6,x                         ; E824 BD D6 11                 ...
        sta     C128_D000,x                         ; E827 9D 00 D0                 ...
        dex                                     ; E82A CA                       .
        bpl     LE824                           ; E82B 10 F7                    ..
        ldy     #$07                            ; E82D A0 07                    ..
LE82F:  lda     C128_D015                           ; E82F AD 15 D0                 ...
...
LE86F:  dey                                     ; E86F 88                       .
        ...
        lda     C128_D019                           ; E872 AD 19 D0                 ...
        sta     C128_D019                           ; E875 8D 19 D0                 ...
        and     #$0E                            ; E878 29 0E                    ).
...
LE87F:  lsr     a                               ; E87F 4A                       J
        ...
        pha                                     ; E882 48                       H
        lda     C128_D01E,y                         ; E883 B9 1E D0                 ...
        ora     $11E7,y                         ; E886 19 E7 11                 ...
        sta     $11E7,y                         ; E889 99 E7 11                 ...
        lda     #$00                            ; E88C A9 00                    ..
        sta     C128_D01E,y                         ; E88E 99 1E D0                 ...
...
LE8A2:  dey                                     ; E8A2 88                       .
        ...
        lda     C128_D013                           ; E8A8 AD 13 D0                 ...
        sta     $11E9                           ; E8AB 8D E9 11                 ...
        lda     C128_D014                           ; E8AE AD 14 D0                 ...
...
LE978:  ldx     $7026,y                         ; E978 BE 26 70                 .&p
        ...
        sta     C128_D400,x                         ; E97E 9D 00 D4                 ...
        lda     $12A0,y                         ; E981 B9 A0 12                 ...
        sta     C128_D401,x                         ; E984 9D 01 D4                 ...
        tya                                     ; E987 98                       .
        tax                                     ; E988 AA                       .
...
; ----------------------------------------------------------------------------
LEA2B:  jmp     C128_7D16                           ; EA2B 4C 16 7D                 L.}
; ----------------------------------------------------------------------------
;Unused
...
LEAEA:  .byte   $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF ; EAEA FF FF FF FF FF FF FF FF  ........
        ...
        ;Encrypted message
        .byte   $E9,$77,$6A,$5F,$5E,$5D         ;            E9 77 6A 5F 5E 5D  .{.wj_^]
...
; ----------------------------------------------------------------------------
        ...
        jmp     C128_84B0                           ; EF00 4C B0 84                 L..
; ----------------------------------------------------------------------------
        ; Convert Integer to F.P.
        jmp     C128_792A                           ; EF03 4C 2A 79                 L*y
; ----------------------------------------------------------------------------
        ; Float to Ascii
        jmp     C128_8E35                           ; EF06 4C 35 8E                 L5.
; ----------------------------------------------------------------------------
        ; String to Float
...
; ----------------------------------------------------------------------------
        ; Evaluate <subtract>
        jmp     C128_882D                           ; EF15 4C 2D 88                 L-.
; ----------------------------------------------------------------------------
        ; Add Memory
        jmp     C128_8841                           ; EF18 4C 41 88                 LA.
; ----------------------------------------------------------------------------
        ; Evaluate <add>
        jmp     C128_8844                           ; EF1B 4C 44 88                 LD.
; ----------------------------------------------------------------------------
        ; Multiply By Memory
        jmp     C128_8A20                           ; EF1E 4C 20 8A                 L .
; ----------------------------------------------------------------------------
        ; Evaluate <multiply>
        jmp     C128_8A23                           ; EF21 4C 23 8A                 L#.
; ----------------------------------------------------------------------------
        ; Divide Into Memory
        jmp     C128_8B3C                           ; EF24 4C 3C 8B                 L<.
; ----------------------------------------------------------------------------
        ; Evaluate <divide>
...
; ----------------------------------------------------------------------------
        ; Defunct Vectors
        jmp     C128_4825                           ; EF6F 4C 25 48                 L%H
; ----------------------------------------------------------------------------
        ; Draw Line
        jmp     C128_9B23                           ; EF72 4C 23 9B                 L#.
; ----------------------------------------------------------------------------
        ; Plot Pixel
        jmp     C128_9BEE                           ; EF75 4C EE 9B                 L..
; ----------------------------------------------------------------------------
        ; Draw Circle
        jmp     C128_673E                           ; EF78 4C 3E 67                 L>g
; ----------------------------------------------------------------------------
        ; Perform [run]
        jmp     C128_5A93                           ; EF7B 4C 93 5A                 L.Z
; ----------------------------------------------------------------------------
        ; Set Up Run
        jmp     C128_51F0                           ; EF7E 4C F0 51                 L.Q
; ----------------------------------------------------------------------------
        ; Perform [clr]
        jmp     C128_51F5                           ; EF81 4C F5 51                 L.Q
; ----------------------------------------------------------------------------
        ; Perform [new]
        jmp     C128_51D3                           ; EF84 4C D3 51                 L.Q
; ----------------------------------------------------------------------------
        ; Rechain Lines
        jmp     C128_4F4C                           ; EF87 4C 4C 4F                 LLO
; ----------------------------------------------------------------------------
        ; Crunch Tokens
        jmp     C128_4307                           ; EF8A 4C 07 43                 L.C
; ----------------------------------------------------------------------------
        ; Find Basic Line
        jmp     C128_5061                           ; EF8D 4C 61 50                 LaP
; ----------------------------------------------------------------------------
        ; ?
        jmp     C128_4AF3                           ; EF90 4C F3 4A                 L.J
; ----------------------------------------------------------------------------
        ; Evaluate Item
        jmp     C128_78C5                           ; EF93 4C C5 78                 L.x
; ----------------------------------------------------------------------------
        ; Evaluate Expression
        jmp     C128_77DD                           ; EF96 4C DD 77                 L.w
; ----------------------------------------------------------------------------
        ; ?
        jmp     C128_5A9E                           ; EF99 4C 9E 5A                 L.Z
; ----------------------------------------------------------------------------
        ; ?
        jmp     C128_5A79                           ; EF9C 4C 79 5A                 LyZ
; ----------------------------------------------------------------------------
        ; Get Fixed Pt Number
        jmp     C128_509D                           ; EF9F 4C 9D 50                 L.P
; ----------------------------------------------------------------------------
        ; Garbage Collection
        jmp     C128_92DD                           ; EFA2 4C DD 92                 L..
; ----------------------------------------------------------------------------
        ; ?
        jmp     C128_4DCA                           ; EFA5 4C CA 4D                 L.M
; ----------------------------------------------------------------------------
;Unused
...
LF050:
        ...
        .byte   $0d,"; ",$1b,"Q",0
        lda     $02                             ; F070 A5 02                    ..
        jsr     C128_F8D2-$4000                     ; F072 20 D2 B8                  ..
        txa                                     ; F075 8A                       .
        jsr     LFFD2_CHROUT                    ; F076 20 D2 FF                  ..
        lda     $03                             ; F079 A5 03                    ..
        jsr     C128_F8C2-$4000                     ; F07B 20 C2 B8                  ..
        ldy     #$02                            ; F07E A0 02                    ..
LF080:  lda     $02,y                           ; F080 B9 02 00                 ...
        jsr     C128_F8A5-$4000                     ; F083 20 A5 B8                  ..
        iny                                     ; F086 C8                       .
        cpy     #$08                            ; F087 C0 08                    ..
...
LF08B:  jsr     C128_F8B4-$4000                     ; F08B 20 B4 B8                  ..
        ldx     #$00                            ; F08E A2 00                    ..
        stx     $7A                             ; F090 86 7A                    .z
...
LF0E3:  jmp     (C128_0A00)       ; Restart System (BASIC Warm) [4000]                  ; F0E3 6C 00 0A                 l..
; ----------------------------------------------------------------------------
...
LF177:  jsr     LFFE1_STOP                      ; F177 20 E1 FF                  ..
        ...
        asl     a                               ; F185 0A                       .
LF186:  jsr     C128_B952                           ; F186 20 52 B9                  R.
...
LF1AB:  bcs     LF1C9                           ; F1AB B0 1C                    ..
        jsr     C128_F901-$4000                     ; F1AD 20 01 B9                  ..
        ldy     #$00                            ; F1B0 A0 00                    ..
...
; Display Memory
LF1E8:  jsr     C128_F8B4-$4000                     ; F1E8 20 B4 B8                  ..
        lda     #$3E                            ; F1EB A9 3E                    .>
        jsr     LFFD2_CHROUT                    ; F1ED 20 D2 FF                  ..
        jsr     C128_F892-$4000                     ; F1F0 20 92 B8                  ..
        ldy     #$00                            ; F1F3 A0 00                    ..
        beq     LF1FA                           ; F1F5 F0 03                    ..
LF1F7:  jsr     C128_F8A8-$4000                     ; F1F7 20 A8 B8                  ..
LF1FA:  jsr     LF11A-$4000                     ; F1FA 20 1A B1                  ..
        jsr     C128_F8C2-$4000                     ; F1FD 20 C2 B8                  ..
        iny                                     ; F200 C8                       .
        cpy     #$08                            ; F201 C0 08                    ..
        bit     $D7                             ; F203 24 D7                    $.
...
LF27A:  jsr     C128_F8B4-$4000                           ; F27A 20 B4 B8                  ..
        ldy     #$00                            ; F27D A0 00                    ..
...
LF299:  ldx     $62                             ; F299 A6 62                    .b
        ...
        jsr     C128_F892-$4000                     ; F2A1 20 92 B8                  ..
        jsr     C128_F8A8-$4000                     ; F2A4 20 A8 B8                  ..
        jsr     C128_F8A8-$4000                     ; F2A7 20 A8 B8                  ..
...
; ----------------------------------------------------------------------------
LF2BA:
        jsr     C128_F922-$4000                     ; F2BA 20 22 B9                  ".
        jsr     C128_F960-$4000                     ; F2BD 20 60 B9                  `.
        jmp     LF2C6-$4000                     ; F2C0 4C C6 B2                 L..
; ----------------------------------------------------------------------------

; Add 1 to Op 3
LF2C3:  jsr     C128_B950                           ; F2C3 20 50 B9                  P.
...
LF307:  sty     $93                             ; F307 84 93                    ..
        jsr     C128_F8B4-$4000                     ; F309 20 B4 B8                  ..
...
LF30E:  jsr     LF11A-$4000                     ; F30E 20 1A B1                  ..
        ...
        jsr     C128_F892-$4000                     ; F31B 20 92 B8                  ..
        jsr     C128_F8A8-$4000                     ; F31E 20 A8 B8                  ..
        jsr     C128_F8A8-$4000                     ; F321 20 A8 B8                  ..
LF324:  jsr     LFFE1_STOP                      ; F324 20 E1 FF                  ..
        beq     LF331                           ; F327 F0 08                    ..
        jsr     C128_B950                           ; F329 20 50 B9                  P.
...
LF373:  stx     $7A                             ; F373 86 7A                    .z
        ...
        jsr     C128_F901-$4000                     ; F388 20 01 B9                  ..
        sta     LA                              ; F38B 85 C6                    ..
        jsr     LB7A7                           ; F38D 20 A7 B7                  ..
        bcs     LF3D1                           ; F390 B0 3F                    .?
        jsr     C128_F8B4-$4000                           ; F392 20 B4 B8                  ..
        ldx     $60                             ; F395 A6 60                    .`
        ldy     $61                             ; F397 A4 61                    .a
        lda     $93                             ; F399 A5 93                    ..
        cmp     #$53                            ; F39B C9 53                    .S
...
LF406:  bcs     LF442                           ; F406 B0 3A                    .:
        jsr     C128_F901-$4000                     ; F408 20 01 B9                  ..
...
LF496:  ldx     #$00                            ; F496 A2 00                    ..
        ...
        stx     $64                             ; F4A3 86 64                    .d
        tax                                     ; F4A5 AA                       .
        lda     C128_F761-$4000,x                         ; F4A6 BD 61 B7                 .a.
        jsr     LF57F-$4000                     ; F4A9 20 7F B5                  ..
        lda     C128_F721-$4000,x                   ; F4AC BD 21 B7                 .!.
...
LF4CC:  asl     $0AAA                           ; F4CC 0E AA 0A                 ...
        ...
        lda     C128_F714-$4000,x                   ; F4D1 BD 14 B7                 ...
        jsr     LF57F-$4000                     ; F4D4 20 7F B5                  ..
        lda     C128_F71A-$4000,x                         ; F4D7 BD 1A B7                 ...
...
LF5D4:  lda     #$2E                            ; F5D4 A9 2E                    ..
        ...
        jsr     C128_F8A8-$4000                     ; F5D9 20 A8 B8                  ..
LF5DC:  jsr     C128_F892-$4000
        jsr     C128_F8A8-$4000                     ; F5DF 20 A8 B8                  ..
        ldy     #$00                            ; F5E2 A0 00                    ..
...
LF5FC:  jsr     LF11A-$4000                     ; F5FC 20 1A B1                  ..
        jsr     C128_F8A5-$4000                     ; F5FF 20 A5 B8                  ..
LF602:  iny                                     ; F602 C8                       .
        cpy     #$03                            ; F603 C0 03                    ..
...
LF618:  lda     $0AAA                           ; F618 AD AA 0A                 ...
        ...
        jsr     C128_F8C2-$4000                           ; F624 20 C2 B8                  ..
        dey                                     ; F627 88                       .
        bne     LF618                           ; F628 D0 EE                    ..
LF62A:  asl     $0AAA                           ; F62A 0E AA 0A                 ...
        bcc     LF63D                           ; F62D 90 0E                    ..
        lda     C128_F714-$4000,x                   ; F62F BD 14 B7                 ...
        jsr     LFFD2_CHROUT                    ; F632 20 D2 FF                  ..
        lda     C128_F71A-$4000,x                   ; F635 BD 1A B7                 ...
...
; Get Mnemonic Char
        tay                                     ; F6A1 A8                       .
        lda     C128_F721-$4000,y  ; Compacted Mnemonics                       ; F6A2 B9 21 B7                 .!.
        sta     $63                             ; F6A5 85 63                    .c
        lda     C128_F761-$4000,y                         ; F6A7 B9 61 B7                 .a.
        sta     $64                             ; F6AA 85 64                    .d
...
LF6B0:  asl     $64                             ; F6B0 06 64                    .d
        ...
        jmp     C128_F8A8-$4000                     ; F6C0 4C A8 B8                 L..
; ----------------------------------------------------------------------------
