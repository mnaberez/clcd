...
L88F4:  phy                                     ; 88F4 5A                       Z
        ...
        ldy     #$13                            ; 88FD A0 13                    ..
        sec                                     ; 88FF 38                       8
        jsr     LB6F9_MAYBE_PUT_CHAR_IN_FKEY_BAR_SLOT                           ; 8900 20 F9 B6                  ..
        ply                                     ; 8903 7A                       z
        ldx     #$29                            ; 8904 A2 29                    .)
L8906:  phy                                     ; 8906 5A                       Z
        lda     ($E4),y                         ; 8907 B1 E4                    ..
...
L8964:  clc                                     ; 8964 18                       .
        ...
        pha                                     ; 8970 48                       H
        sec                                     ; 8971 38                       8
        jsr     LB6F9_MAYBE_PUT_CHAR_IN_FKEY_BAR_SLOT                           ; 8972 20 F9 B6                  ..
        lda     #$65                            ; 8975 A9 65                    .e
        ply                                     ; 8977 7A                       z
        sta     ($BD),y                         ; 8978 91 BD                    ..
        lda     #$A7                            ; 897A A9 A7                    ..
L897C:  clc                                     ; 897C 18                       .
        jmp     LB6F9_MAYBE_PUT_CHAR_IN_FKEY_BAR_SLOT                           ; 897D 4C F9 B6                 L..
; ----------------------------------------------------------------------------
